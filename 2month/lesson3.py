...
# |Наследование	 |класс получает свойства другого класса
# |Полиморфизм	 |один метод работает по-разному
...
# obj.age = age
"""
Абстракция - принцип ООП, в котором создается класс-пустышка, 
где задаются названия аттрибутов и методов, для того, чтобы в дочерних классах 
не забыть их перепределить.
"""
