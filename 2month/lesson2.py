...
# Полиморфизм → один метод ведёт себя по-разному

"""
Наследование - принцип ООП, 
в котором мы можем унаследовать, переопределить и использовать 
в дочернем классе все аттрибуты и методы родительского класса
"""
class A:
    def method(self):
